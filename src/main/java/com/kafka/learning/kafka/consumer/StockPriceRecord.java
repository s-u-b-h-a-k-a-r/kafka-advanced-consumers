...
public class StockPriceRecord {
    ...
    public StockPriceRecord(String topic, int partition, long offset, String name, int dollars, int cents, boolean saved) {
        this.topic = topic;
    ...
    public StockPriceRecord(StockPrice value, boolean saved, ConsumerRecord<String, StockPrice> record) {
